...
def train_loop_survival_coattn(epoch, model, loader, optimizer, n_classes, writer=None, loss_fn=None, reg_fn=None, lambda_reg=0., gc=16, args=None
    ...
    for batch_idx, (data_WSI, data_omic1, data_omic2, data_omic3, data_omic4, data_omic5, data_omic6, label, event_time, c,case_ids) in enumerate(loader):
        ...
        hazards, S, Y_hat, A \
            = model(x_path=data_WSI, x_omic1=data_omic1, x_omic2=data_omic2, x_omic3=data_omic3, x_omic4=data_omic4, x_omic5=data_omic5, x_omic6=data_omic6)
        ...
        if (batch_idx + 1) % 100 == 0:
            train_batch_str = 'batch {}, loss: {:.8f}, label: {}, event_time: {:.4f}, risk: {:.4f}'.format(
...
def validate_survival_coattn(cur, epoch, model, loader, n_classes, early_stopping=None, monitor_cindex=None,
    ...
    for batch_idx, (data_WSI, data_omic1, data_omic2, data_omic3, data_omic4, data_omic5, data_omic6, label, event_time, c,
    case_ids) in enumerate(loader):
        ...
        slide_id = current_case_id

        with torch.no_grad():
            hazards, S, Y_hat, attention_scores = model(x_path=data_WSI, x_omic1=data_omic1, x_omic2=data_omic2,
